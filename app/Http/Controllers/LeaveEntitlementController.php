...
public function store(Request $request)
    {
        ...
        return $this->handleTransaction(function () use ($validatedData) {
            ...
            $leavePeriod = LeavePeriod::where('id', $validatedData['leave_period_id'])
            ...
            $employees = $validatedData['employees'] ?? Employee::where('business_id', $business->id)->pluck('id')->toArray();
            $leaveEntitlements = [];
