<form id="departmentsForm" method="post">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" id="department_name" name="department_name" required
            placeholder="e.g Finance" value="{{ isset($department) ? $department->name : old('department_name') }}">
    </div>
    ...
    <div>
        <button onclick="saveDepartment(this)" type="button" id="submitButton" class="btn btn-primary w-100">
