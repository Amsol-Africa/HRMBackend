<form id="shiftsForm" method="post">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" id="shift_name" name="shift_name" required
            placeholder="e.g Morning Shift" value="{{ isset($shift) ? $shift->name : old('shift_name') }}">
    </div>
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control timepicker" id="start_time" name="start_time" required
            placeholder="e.g 08:00" value="{{ isset($shift) ? $shift->start_time->format('H:i') : old('start_time') }}">
    </div>

    <div class="form-group mb-3">
        <label for="end_time">End Time</label>
        <input type="text" class="form-control timepicker" id="end_time" name="end_time" required
            placeholder="e.g 16:00" value="{{ isset($shift) ? $shift->end_time->format('H:i') : old('end_time') }}">
    </div>

    <div>
        <button onclick="saveShift(this)" type="button" id="submitButton" class="btn btn-primary w-100">
