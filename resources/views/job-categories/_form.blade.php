<form id="jobCategoriesForm" method="post">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" id="job_category" name="job_category" required placeholder="e.g Finance"
            value="{{ isset($job_category) ? $job_category->name : old('job_category') }}">
    </div>
    ...
    <div>
        <button onclick="saveJobCategory(this)" id="submitButton" type="button" class="btn btn-primary w-100">
