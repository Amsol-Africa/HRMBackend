<form id="loanForm" method="post">
    ...
    <div class="row g-2 mb-3">
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="amount" name="amount" required min="1"
                step="0.01" value="{{ isset($loan) ? $loan->amount : old('amount') }}">
        </div>

        <div class="col-md-6">
            <label for="interest_rate">Interest Rate (%)</label>
            <input type="number" class="form-control" id="interest_rate" name="interest_rate" min="0"
                step="0.01" value="{{ isset($loan) ? $loan->interest_rate : old('interest_rate') }}">
    ...
    <div class="row g-2 mb-3">
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="term_months" name="term_months" min="1"
                value="{{ isset($loan) ? $loan->term_months : old('term_months') }}">
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control datepicker" id="start_date" name="start_date" required
                value="{{ isset($loan) ? $loan->start_date : old('start_date') }}">
        </div>
    </div>
    ...
    <div>
        <button onclick="saveLoan(this)" type="button" id="submitButton" class="btn btn-primary w-100">
