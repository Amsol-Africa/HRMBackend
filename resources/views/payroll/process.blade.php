<x-app-layout>
            ...
            <div class="card">
                <div class="card-body">
                    <form id="processPayroll">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="payrun_month" name="payrun_month" class="form-select">
                                    ...
                                    @php
                                    $isDisabled = now()->year == request('payrun_year', now()->year) && $month >
                                    now()->month;
                                    @endphp
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="repay_loans" name="repay_loans"
                                        value="1" checked>
                                    <label class="form-check-label" for="">Repay Loans</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="recover_advance"
                                        name="recover_advance" value="1" checked>
                                    <label class="form-check-label" for="">Recover Advance</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="pay_overtime"
                                        name="pay_overtime" value="1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary w-100" onclick="processPayroll(this)"> <i
                                        class="bi bi-check-circle me-1"></i> Process Payroll </button>
                            </div>
                        </div>
    ...
    <div class="row g-20">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-3">
                        <i class="fa-solid fa-people me-2"></i> Employee Summary
                    </h6>

                    <div class="d-flex gap-2 mb-3">
                        <!-- Deductions -->
                        <button class="btn btn-danger">
                            <i class="fa-solid fa-minus-circle me-1"></i> Add Deductions
                        </button>
                        <!-- Allowances -->
                        <button class="btn btn-success">
                            <i class="fa-solid fa-plus-circle me-1"></i> Add Allowances
                        </button>
                    </div>

                    <div id="employeePayslipsContainer"></div>
    ...
    let payrollRedirectUrl = "{{ route('business.payroll.index', $currentBusiness->slug) }}";
    </script>
