<x-app-layout>
    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="on-leave-tab" data-bs-toggle="tab" data-bs-target="#on-leave"
                    type="button" role="tab" aria-controls="on-leave" aria-selected="false">On Leave</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="notice-exit-tab" data-bs-toggle="tab" data-bs-target="#notice-exit"
                    type="button" role="tab" aria-controls="notice-exit" aria-selected="false">On Notice of
                    Exit</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="inactive-tab" data-bs-toggle="tab" data-bs-target="#inactive"
                    type="button" role="tab" aria-controls="inactive" aria-selected="false">Inactive</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="exited-tab" data-bs-toggle="tab" data-bs-target="#exited" type="button"
                    role="tab" aria-controls="exited" aria-selected="false">Exited</button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="d-flex align-items-center justify-content-between gap-15">
                        <button type="button" onclick="searchEmployees(this)" class="btn btn-secondary"> <i
                                class="bi bi-funnel"></i> Filters</button>
                        <a href="{{ route('business.employees.create', $currentBusiness->slug) }}"
                            class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#addNewEmployee"> <i
