...
<body>
    ...
    <div class="header">
        ...
        <div class="right">
            ...
            <p class="text-muted">Total Contacts: {{ $contacts->count() }}</p>
        </div>
    </div>

    <!-- Table -->
    @if($contacts->isEmpty())
    <p>No contacts available for this business.</p>
    @else
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ ucfirst($submission->status ?? 'N/A') }}</td>
        ...
        <tfoot>
            <tr>
                <td colspan="11" class="text-right"><strong>Total Contacts:</strong></td>
                <td><strong>{{ $contacts->count() }}</strong></td>
            </tr>
        </tfoot>
    </table>
    @endif
